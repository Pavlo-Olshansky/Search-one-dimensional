...
class Golden_cut(Find_Interval):
    def __init__(self, coeffs_g=None, starting_point_g=None, delta_g=None, epsilon_g=None):
        super().__init__(coeffs_g, starting_point_g, delta_g)
        self.epsilon_g = epsilon_g

    def get_x1(self, interval, L):
        return interval[0] + 0.382 * L

    def get_x2(self, interval, L):
        return interval[0] + 0.618 * L
